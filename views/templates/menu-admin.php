<ul class="menu">
   ...
   <li class="menu__item <?php echo paginaActual('matriculas') ? 'menu__activo' : ''; ?>">
      <div class="menu__enlace menu__icono">
      <i class="fa-solid fa-book"></i>
         <span class="menu__nombre">Matrícula</span>
      </div>
      <ul class="menu__submenu">
         <li class="menu__item--sub">
            <a href="/admin/matriculas/crear" class="menu__enlace">
               <i class="fa-solid fa-caret-right"></i>
               <span class="menu__nombre">Nueva Matrícula</span>
            </a>
         </li>
         <li class="menu__item--sub">
            <a href="/admin/matriculas" class="menu__enlace">
               <i class="fa-solid fa-caret-right"></i>
               <span class="menu__nombre">Matrículas</span>
            </a>
         </li>
         <li class="menu__item--sub">
            <a href="/admin/matriculas/incidencia" class="menu__enlace">
               <i class="fa-solid fa-caret-right"></i>
               <span class="menu__nombre">Incidencias</span>
            </a>
         </li>
      </ul>
   </li>
