...
class Cliente extends ActiveRecord {
   ...
   protected static $columnasDB = ['id', 'nombre', 'apellidoPaterno', 'apellidoMaterno', 'fechaNacimiento', 'tipoDocumento', 'numeroDocumento', 'email', 'idProfesion', 'idGrado', 'colegiatura', 'estado'];
